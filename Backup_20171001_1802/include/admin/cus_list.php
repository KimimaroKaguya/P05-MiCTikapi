                                    ...
                                    <tbody>
												...
												<?php
													...
													echo "<tr>";
														...
														echo "<td>";
														echo "<a href='index.php?opt=cus_edit&id=".$result['em_id']."' title='Edit'><img src='../img/edit.png' width=20px></a>";
														echo "&nbsp;<a href='index.php?opt=cus_list&id=".$result['em_id']."' title='Delete'><img src='../img/delete.png' width=20px></a></td>";														
													echo "</tr>";
													}
												?>
