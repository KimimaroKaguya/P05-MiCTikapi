...
<form name="user" action="" method="post">
      <div class="row">
        ...
        <div class="<?php print panel_modify();?>">
						...
						<table class="table table-striped table-hover" id="dataTables-example">
                                  <thead>
                                    ...
                                    <?php
													...
													$query=mysql_query("SELECT * FROM mt_gen WHERE mt_id='".$mt_id."'");
												$no==1;
               ...
               $danger=button_btn_submit_account($account,$text_danger,'',$bottonbtn_danger);
                                    # $delete_use="on";
									 # $disable_use="on";
									  #$enable_use="on";
									   $print_use="on";
							   ...
							   $csv=botton_account($account,'','','','','',$csv_use);
									...
									echo $danger; echo $del ;echo $dis; echo $ena;echo $pri;echo $csv;
									  ?>
