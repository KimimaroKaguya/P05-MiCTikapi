...
if($run=="pppoe")
{
    ...
    while($part3=mysql_fetch_array($query4))
    {
        ...
        if(($new_update)>0)
        {
            echo "<script language='javascript'>swal('Save Done!','UPDATE ข้อมูล ".$run." จำนวน ".$new_update." รายการสำเร็จแล้ว','success').then(function () {            }, function (dismiss) {
            if (dismiss === 'overlay') {                
            }})</script>";
        }
        else
    ...
    <!--row 1  -->
        <div class="col-lg-3 col-xs-6">
            <div class="small-box <?php print bg_color_modify(1);?>">
                ...
                <a href="#" class="small-box-footer">สถานะ CPU <i class="fa fa-rocket"></i></a>
            </div>
        </div>
    <!-- ./box1 col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box <?php print bg_color_modify(3);?>">
                ...
                <a href="javascript:popup('index.php?page=mikrotikuser')"  class="small-box-footer">
                    Hotspot <?php 
                        $ARRAY = $API->comm("/ip/hotspot/user/print", array("count-only"=> "","~active-address" => "1.1.",));
                        print_r($ARRAY)
                        ?> User    
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box <?php print bg_color_modify(4);?>">
                ...
                <a href="javascript:popup('index.php?page=pppoe_mik_user')"  class="small-box-footer">
                    PPPoe <?php 
                        $ARRAY = $API->comm("/ppp/secret/print", array("count-only"=> "","~active-address" => "1.1.",));
                ...
                <div class="<?php print $panel_heading;?>">                                                                
                    <span class="hidden-md hidden-sm hidden-xs">    
                        <div id="maximize" class="allsize" style="display:block;float: left;" >
                            <button  id="sidebar-show-btn" type="button" class="btn btn-box-tool" data-toggle="tooltip" title= "คลิก เพื่อขยาย มอนิเตอร์" onclick="toggle_visibility('pull-right-on'),toggle_visibility('pull-right-off'),toggle_visibility_size('restore')"> 
                            <h3 class="box-title"><i class="fa fa-window-maximize"></i>&nbsp;&nbsp;&nbsp;MONITOR</h3></button>
                        </div>
                    </span>                            
                    <div id="restore" class="allsize" style="display:none;float: left;" >
                        <button  id="sidebar-hide-btn" type="button" class="btn btn-box-tool" data-toggle="tooltip"  title= "คลิก เพื่อลดขนาด มอนิเตอร์" onclick="toggle_visibility('pull-right-off'),toggle_visibility('pull-right-on'),toggle_visibility_size('maximize')">
                            <h3 class="box-title"><i class="fa fa-window-restore"></i>&nbsp;&nbsp;&nbsp;MONITOR</h3></button>
                        <span class="hidden-md hidden-sm hidden-xs">
                    ...
                    <div class="chart">
                        <div class="row">
							...
							<div class="row">
                                <span class="style1"><div class="col-xs-6">Uptime </div>
                                    <div class="col-xs-6">
                                       <div class="text"><?php print $resource_dash['0']['uptime']; ?></div></span>
                                    </div>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">Device Name </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['platform'];?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style1"> <div class="col-xs-6">Model</div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['board-name'];?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">Version  </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['version'];?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style1"><div class="col-xs-6">CPU </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['cpu'];?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">CPU Count </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['cpu-count']." Core"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style1"><div class="col-xs-6">CPU Frequency </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['cpu-frequency']." MHz"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">CPU Load </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash['0']['cpu-load']." %"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style1"><div class="col-xs-6">Free Memory </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print round(($resource_dash['0']['free-memory']/1048576),1)." MB"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">Total Memory </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print round(($resource_dash[0]['total-memory']/1048576),1)." MB"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style1"><div class="col-xs-6">Free HDD Space </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print round(($resource_dash[0]['free-hdd-space']/1048576),1)." MB"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">Total HDD Size </div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print round(($resource_dash[0]['total-hdd-space']/1048576),1)." MB"; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style1"><div class="col-xs-6">Architecture Name</div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['architecture-name']; ?></div>
                                    </div></span>
                            </div>
                            <div class="row">
                                <span class="style2"><div class="col-xs-6">Build Time</div>
                                    <div class="col-xs-6">
                                        <div class="text"><?php print $resource_dash[0]['build-time']; ?></div>
                                    </div></span>
                            </div>
                            <br>						 
						</div>
                        ...
                        <div class="col-md-6 col-xs-12">
							<div class="text-center"><h3><strong>Mikrotik Health</strong></h3></div><br><br>
							    <div class="row">
                                    <span class="style3"><div class="col-xs-6">Fan Mode
                                </div>
                                <div class="col-xs-6">
                                    <div class="text"><?php print $health_dash[0]["fan-mode"]; ?></div>
                                </div></span>
                            </div>
                        <div class="row">
                            <span class="style4"><div class="col-xs-6">Use Fan</div>
                            <div class="col-xs-6">
                              <div class="text"><?php print $health_dash[0]["use-fan"]; ?></div>
                            </div></span>
                        </div>
                        <div class="row">
                            <span class="style3"><div class="col-xs-6">Active Fan</div>
                            <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['active-fan']; ?></div>
                            </div></span>
                        </div>
                        <div class="row">
                                <span class="style4"><div class="col-xs-6">Voltage. </div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['voltage']." Volt"; ?></div>
                                </div></span>
                        </div>
                        <div class="row">
                                <span class="style3"><div class="col-xs-6">Temperature</div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['temperature']." C"; ?></div>
                                </div></span>
                        </div>
                        <div class="row">
                                <span class="style4"><div class="col-xs-6">CPU Temperature</div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['cpu-temperature']." C"; ?></div>
                                </div></span>
                        </div>
                        <div class="row">
                                <span class="style3"><div class="col-xs-6">Current. </div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['current']." mA"; ?></div>
                                </div></span>
                        </div>
                        <div class="row">
                                <span class="style4"><div class="col-xs-6">Power Consumption</div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['power-consumption']." Watt"; ?></div>
                                </div></span>
                        </div>
                        <div class="row">
                                <span class="style3"><div class="col-xs-6">Fan1 Speed</div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['fan1-speed']." RPM"; ?></div>
                                </div></span>
                        </div>
                        <div class="row">
                                <span class="style4"><div class="col-xs-6">Fan2 Speed</div>
                                <div class="col-xs-6">
                                <div class="text"><?php print $health_dash['0']['fan2-speed']." RPM"; ?></div>
                                </div></span>
                        </div>
                    </div>
                    <!-- /.col-->
                                ...
                                <div class="col-md-4 col-xs-12">
                                    <a href="index.php?page=pppoe_profile_list"class="btn btn-app">
                                        <span class="badge <?php print bg_color_modify(2);?>"><?php $ARRAY = $API->comm("/ppp/profile/print", array(
                                            ...
                                            "~active-address" => "1.1.",));
                                            print_r($ARRAY)?></span>
                                        <i class="fa fa-folder-open"></i> PPPOE Profile</a>			  
                                    <a href="index.php?page=pppoe_mik_user"class="btn btn-app">
                                        ...
                                        <i class="fa fa-users"></i> PPPOE Users</a>
	...
	<div id="pull-right-on" style="display:block;">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">     
            <div class="info-box <?php print bg_color_modify(5);?>">
                <span class="info-box-icon">
                    ...
                    <i class="ion ion-ios-people-outline"  style="color: #ffffff;"></i></a>
                </span>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box <?php print bg_color_modify(6);?>">
                <span class="info-box-icon"><a href="javascript:popup('index.php?page=listuser')"><i class="ion-ios-pricetags-outline" style="color: #ffffff;"></i></a></span>
                <div class="info-box-content">
